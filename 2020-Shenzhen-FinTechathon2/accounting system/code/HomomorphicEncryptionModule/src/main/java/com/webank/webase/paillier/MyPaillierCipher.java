...
public class MyPaillierCipher {

    public static String encrypt(BigInteger m, PublicKey publicKey, BigInteger bin) {
        return CommonUtils.byteToHexString(encryptAsBytes(m, publicKey, bin));
    }

    public static byte[] encryptAsBytes(BigInteger m, PublicKey publicKey, BigInteger bin) {
        RSAPublicKey rsaPubKey = (RSAPublicKey) publicKey;
        BigInteger n = rsaPubKey.getModulus();
        BigInteger g = n.add(BigInteger.ONE);

        BigInteger random = bin;
//        do {
