...
public class P2PTimeService {
    ...
    public String apply() throws Exception {
        if (p2pTime != null)
            return p2pTime.apply().send().getTransactionHash();
        else return "";
    }
    ...
    public P2PInfo getP2PAllInfo() throws Exception {
        ...
        p2pAllInfo.setPublish_time(p2pInfo.getValue4().toString());
        p2pAllInfo.setDescription(p2pInfo.getValue5());
        p2pAllInfo.setDeadline(p2pInfo.getValue6().toString());
