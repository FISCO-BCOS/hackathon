...
public class DAOService {
    ...
    public String pay(BigInteger timeToken) throws Exception {
        String hash="";
        if (dao != null) {
            TransactionReceipt tr = dao.pay(timeToken).send();
    ...
    public int get_amountRaised() throws Exception {
        BigInteger amountRaised;
        amountRaised = dao.amountRaised().send();
        return Integer.valueOf(amountRaised.toString());
    }
