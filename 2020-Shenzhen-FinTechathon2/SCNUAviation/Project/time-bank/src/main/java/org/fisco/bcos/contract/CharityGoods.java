...
public class CharityGoods extends Contract {
    ...
    public RemoteCall<TransactionReceipt> sell(String _goods_name, BigInteger _goods_number, BigInteger _goods_price, BigInteger _timeToken) {
        final Function function = new Function(
                FUNC_SELL, 
                Arrays.<Type>asList(new org.fisco.bcos.web3j.abi.datatypes.Utf8String(_goods_name), 
                new org.fisco.bcos.web3j.abi.datatypes.generated.Uint256(_goods_number), 
                new org.fisco.bcos.web3j.abi.datatypes.generated.Uint256(_goods_price), 
                new org.fisco.bcos.web3j.abi.datatypes.generated.Uint256(_timeToken)), 
    ...
    public RemoteCall<TransactionReceipt> purchase_phase2(BigInteger ledger_id, BigInteger _bank_serials_number) {
        final Function function = new Function(
                ...
                Arrays.<Type>asList(new org.fisco.bcos.web3j.abi.datatypes.generated.Uint256(ledger_id), 
                new org.fisco.bcos.web3j.abi.datatypes.generated.Uint256(_bank_serials_number)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteCall<TransactionReceipt> interrupt_deadline(String _buyer, BigInteger ledger_id) {
        final Function function = new Function(
                ...
                new org.fisco.bcos.web3j.abi.datatypes.generated.Uint256(ledger_id)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public static RemoteCall<CharityGoods> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider, String _tokenTime, String _dao) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.fisco.bcos.web3j.abi.datatypes.Address(_tokenTime), 
                new org.fisco.bcos.web3j.abi.datatypes.Address(_dao)));
