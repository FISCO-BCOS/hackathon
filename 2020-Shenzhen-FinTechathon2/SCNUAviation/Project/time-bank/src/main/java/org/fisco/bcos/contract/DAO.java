...
public class DAO extends Contract {
    ...
    public RemoteCall<TransactionReceipt> pay(BigInteger timeToken) {
        final Function function = new Function(
                FUNC_PAY, 
                Arrays.<Type>asList(new org.fisco.bcos.web3j.abi.datatypes.generated.Uint256(timeToken)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public static RemoteCall<DAO> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider, String _title, String _description, BigInteger fundingGoalInToken, BigInteger durationInDays, String addressOfToken) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.fisco.bcos.web3j.abi.datatypes.Utf8String(_title), 
                new org.fisco.bcos.web3j.abi.datatypes.Utf8String(_description), 
                new org.fisco.bcos.web3j.abi.datatypes.generated.Uint256(fundingGoalInToken), 
                new org.fisco.bcos.web3j.abi.datatypes.generated.Uint256(durationInDays), 
                new org.fisco.bcos.web3j.abi.datatypes.Address(addressOfToken)));
