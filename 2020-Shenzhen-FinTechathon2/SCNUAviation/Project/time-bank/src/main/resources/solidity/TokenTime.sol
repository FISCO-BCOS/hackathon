...
contract TokenTime {
    ...
    //construct function
    constructor(uint256 _initialSupply, string tokenName, string tokenSymbol) public {
        admin == msg.sender;
...
//        balanceOf[msg.sender] = totalSupply;
    ...
    function initial_balance(address user) public onlyAdmin {
        balanceOf[user] = initial_supply;
    }
