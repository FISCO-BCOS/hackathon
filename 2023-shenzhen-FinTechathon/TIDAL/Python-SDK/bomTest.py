...
def init_contract():
    ...
    client = BcosClient()
    contract_address = '0x43d2d8b065f0ac171993412b19acd7d71118c478'
...
def insertValues(aimKey, databaseIndices, hashValue):
    ...
    client.sendRawTransactionGetReceipt(contract_address ,contract_abi,"insert", args_insert)
    # End the contract.
    end_contract(client)
...
def updateHashOnKey(aimKey, newHash):
    ...
    client.sendRawTransactionGetReceipt(contract_address, contract_abi, "update", args_update)
...
def deleteByKey(aimKey, databaseIndices):
    ...
    client.sendRawTransactionGetReceipt(contract_address, contract_abi, "remove", args_remove)
    # End the contract.
    end_contract(client)
...
def main():
    ...
    # # Call select function.
    # desireKey = "D"
    # print(selectByKey(desireKey))

    # # Call insert function.
    # args_insert = ["D", 3, "2019"]
    # insertValues(*args_insert)

    # newTestKey = "D"
    # print(selectByKey(newTestKey))

    # Call update function.

    # args_update = ["D", "2020"]
    # updateHashOnKey(*args_update)
    # print(selectByKey(desireKey))
