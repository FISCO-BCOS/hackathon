  ...
  >
    ...
    >
      <div class="md:w-3/5 w-10/12 h-full flex items-center justify-evenly">
        <div class="oblique h-[130%] w-3/5 bg-white absolute -ml-52" />
        <!-- 分割斜块 -->
        <div class="z-[999] pt-12 pb-10 md:w-96 w-full  rounded-lg flex flex-col justify-between box-border" style="margin-top: -200px;">
          <div>
            ...
            <div class="mb-9" >
              <p class="text-center text-3xl font-bold" >请登录</p>
              <!--<p class="text-center text-4xl font-bold">{{ $GIN_VUE_ADMIN.appName }}</p>-->
              <p class="text-center text-sm font-normal text-gray-500 mt-2.5" >powered by GVA, GO and FISCO
              </p>
            </div>
            <el-form
              ref="loginForm"
