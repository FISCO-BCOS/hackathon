...
@Component
public class ReadTempZkFile { // 定义 ReadFile 类


    private String filePath ="E:\\java\\本地服务器以及本地前端\\test1\\src\\main\\java\\szu\\zhl\\test1\\utils\\proof.json";


    // 定义一个方法，用于读取 JSON 文件并将其内容转换为 HashMap

    public HashMap<String, Object> readJsonFileToMap() {
