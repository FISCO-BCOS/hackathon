            ...
            >
              <template #label>
                <div>
                  <span> 高亮菜单 </span>
                  <el-tooltip
                    content="��：当到达此路由时候，指定左侧菜单指定name会处于活跃状态（亮起），可为空，为空则为本路由Name。"
                    placement="top"
                    effect="light"
                  >
...
const handleComponentChange = () => {
  ...
  const componentPath = "/src/" + form.value.component
  if (pathInfo[componentPath]) {
    form.value.name = toLowerCase(pathInfo[componentPath])
