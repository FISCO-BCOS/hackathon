...
module.exports.deploy = async function (networkConfig, account, privateKey, contractPath, workspaceRoot) {
    let outputDir = path.join(workspaceRoot, '../build');
    // TODO use truffle instead

   //you can use make deps to compileContract from workspaceRoot.
