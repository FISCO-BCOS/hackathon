...
// Service implements an FiscoBcos netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server         // Peer-to-peer server to retrieve networking infos
	eth    *eth.FiscoBcos      // Full FiscoBcos service if monitoring a full node
	les    *les.LightFiscoBcos // Light FiscoBcos service if monitoring a light node
...
func New(url string, ethServ *eth.FiscoBcos, lesServ *les.LightFiscoBcos) (*Service, error) {
