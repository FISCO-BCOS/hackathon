...
!define HELPURL "https://github.com/chislab/go-fiscobcos/issues"
!define UPDATEURL "https://github.com/chislab/go-fiscobcos/releases"
!define ABOUTURL "https://github.com/chislab/go-fiscobcos#fiscobcos-go"
...
Section "Geth" GETH_IDX
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "FiscoBcos" 30303 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "FiscoBcos" "" 30303 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "FiscoBcos" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/chislab/EIPs/issues/147)
