...
import (
	...
	"github.com/chislab/go-fiscobcos/internal/jsre"
	"github.com/chislab/go-fiscobcos/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute FiscoBcos requests through
