...
// See https://github.com/chislab/EIPs/issues/176 for the test format specification.
...
func MakePreState(db ethdb.Database, accounts core.GenesisAlloc) *state.StateDB {
	...
	for addr, a := range accounts {
		...
		statedb.SetNonce(addr, a.RandomId)
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/chislab/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
	...
	msg := types.NewMessage(from, to, tx.RandomId, value, gasLimit, tx.GasPrice, data, true)
	return msg, nil
}
