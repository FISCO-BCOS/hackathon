...
// Whisper represents a dark communication interface through the FiscoBcos
...
// New creates a Whisper client ready to communicate through the FiscoBcos P2P network.
