...
import (
	...
	"github.com/chislab/go-fiscobcos/common/fdlimit"
	...
	"github.com/chislab/go-fiscobcos/dashboard"
	...
	"github.com/chislab/go-fiscobcos/metrics/influxdb"
	...
	"github.com/chislab/go-fiscobcos/p2p/netutil"
...
// RegisterEthService adds an FiscoBcos client to the stack.
func RegisterEthService(stack *node.Node, cfg *eth.Config) {
	...
	if err != nil {
		Fatalf("Failed to register the FiscoBcos service: %v", err)
	}
}
...
// RegisterEthStatsService configures the FiscoBcos Stats daemon and adds it to
// the given node.
func RegisterEthStatsService(stack *node.Node, url string) {
	if err := stack.Register(func(ctx *node.ServiceContext) (node.Service, error) {
		// Retrieve both eth and les services
		var ethServ *eth.FiscoBcos
		ctx.Service(&ethServ)
		...
		Fatalf("Failed to register the FiscoBcos Stats service: %v", err)
	}
}
