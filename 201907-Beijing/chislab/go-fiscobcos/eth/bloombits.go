...
const (
	// bloomServiceThreads is the number of goroutines used globally by an FiscoBcos
...
func (eth *FiscoBcos) startBloomHandlers(sectionSize uint64) {
...
// for the FiscoBcos header bloom filters, permitting blazing fast filtering.
