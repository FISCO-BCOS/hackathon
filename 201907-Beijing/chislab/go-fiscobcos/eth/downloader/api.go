...
// Syncing provides information when this nodes starts synchronising with the FiscoBcos network and when it's finished.
...
type SyncingResult struct {
	...
	Status  fiscobcos.SyncProgress `json:"status"`
}
