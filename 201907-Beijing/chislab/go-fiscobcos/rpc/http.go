...
func (c *Client) sendHTTP(ctx context.Context, op *requestOp, msg interface{}) error {
	...
	var respfiscomsg jsonrpcFiscoMsg

	if err := json.NewDecoder(respBody).Decode(&respfiscomsg); err != nil {
		return err
	}
	respmsg.Version = respfiscomsg.Jsonrpc
	respmsg.ID = respfiscomsg.ID
	respmsg.Result = respfiscomsg.Result.Output
	op.resp <- &respmsg
	return nil
}
