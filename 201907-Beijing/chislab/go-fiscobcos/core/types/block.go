...
// DecodeRLP decodes the FiscoBcos
...
// EncodeRLP serializes b into the FiscoBcos RLP block format.
...
func (b *Block) RandomId() uint64         { return binary.BigEndian.Uint64(b.header.RandomId[:]) }
