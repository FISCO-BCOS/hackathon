...
// Package state provides a caching layer atop the FiscoBcos state trie.
package state
...
// StateDBs within the fiscobcos protocol are used to store anything
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/chislab/go-fiscobcos/pull/16485#issuecomment-380438527),
