...
// Contains a wrapper for the FiscoBcos client.
...
// FiscoBcosClient provides access to the FiscoBcos APIs.
type FiscoBcosClient struct {
	client *ethclient.Client
}

// NewFiscoBcosClient connects a client to the given URL.
func NewFiscoBcosClient(rawurl string) (client *FiscoBcosClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl)
	return &FiscoBcosClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *FiscoBcosClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *FiscoBcosClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *FiscoBcosClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *FiscoBcosClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *FiscoBcosClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *FiscoBcosClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *FiscoBcosClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *FiscoBcosClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *FiscoBcosClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *FiscoBcosClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *FiscoBcosClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *FiscoBcosClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *FiscoBcosClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *FiscoBcosClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *FiscoBcosClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *FiscoBcosClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *FiscoBcosClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *FiscoBcosClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *FiscoBcosClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *FiscoBcosClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *FiscoBcosClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *FiscoBcosClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *FiscoBcosClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *FiscoBcosClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *FiscoBcosClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *FiscoBcosClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *FiscoBcosClient) SendTransaction(ctx *Context, tx *Transaction) error {
