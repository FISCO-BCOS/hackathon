...
class RaftMessageInterface;
class ViewChangeMsgInterface;
class NewViewMsgInterface;
class RaftConfig;
class RaftCacheProcessor;
class RaftProposalInterface;
...
class PBFTEngine : public ConsensusEngine, public std::enable_shared_from_this<RaftEngine>
{
public:
