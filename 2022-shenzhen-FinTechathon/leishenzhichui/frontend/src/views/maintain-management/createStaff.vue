        ...
        <el-row :gutter="10">
          <el-col :xs="24" :sm="12" :md="8" :lg="8">
            <el-form-item label="姓名" prop="name">
              <el-input v-model="temp.name" placeholder="请输入维修工姓名"></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="8" :lg="8">
            <el-form-item label="员工编号" prop="station">
              <el-input v-model="temp.id" placeholder="请输入员工编号"/>
            </el-form-item>
          </el-col>
        </el-row>
      </el-card>
...
import {staffCreate} from '@/api/api'
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          this.$confirm('是否提交数据？', '温馨提示', {
            ...
            staffCreate(this.temp).then(res => {
              this.$message({
                type: 'success',
                message: '提交成功',
                showClose: true
