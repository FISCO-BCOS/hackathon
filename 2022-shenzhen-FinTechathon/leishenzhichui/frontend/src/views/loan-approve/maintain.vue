<template>
  <div id="loan-application">
    ...
    <el-table :data="tableData" ref="table" height="70vh" style="width: 100%;">
      ...
      <el-table-column align="center" prop="" label="职工编号" width="250"></el-table-column>
      <el-table-column align="center" prop="" label="身份认证结果" width="150"></el-table-column>
      <el-table-column align="center" prop="" label="维修状态" width="150"></el-table-column>
      <el-table-column align="center" label="操作">
        <template v-slot="{row}">
          <el-button size="mini" type="warning" @click="evaluate(row)">身份认证</el-button>
...
<script>
import {firstList, firstReject, firstPass, loanQuery} from '@/api/api'
...
export default {
  ...
  methods: {
    getList() {
      firstList(this.firstQuery).then(res => {
        let {code} = res.data;
        if (code === 20000) {
