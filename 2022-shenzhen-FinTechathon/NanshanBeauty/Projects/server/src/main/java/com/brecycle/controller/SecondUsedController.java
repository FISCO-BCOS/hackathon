...
@Api(tags = "梯次利用模块")
@RestController
@RequestMapping("secondUsed")
public class SecondUsedController {
    ...
    Response apply(@ApiParam(value = "参数", required = true) SecUsedApplyParam param,
        ...
        secondUsedService.apply(batteryIds, param, userName);
    ...
    Response list(@RequestBody @ApiParam(value = "参数", required = true) TradeListParam param) {
        PageResult<TradeListDTO> result = secondUsedService.list(param);
