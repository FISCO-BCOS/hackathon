                ...
                <el-container>
                    ...
                    <el-main>
                        ...
                        <el-form ref="ruleFormRef" :model="ruleForm" label-position="top" status-icon :rules="rules"
                            ...
                            <el-form-item label="交易积分额度" prop="id">
                                <el-input v-model="ruleForm.id" clearable />
                            </el-form-item>

                            <el-radio-group v-model="diabaled" prop="hasTraget" size="large" @change="change">
                                <el-radio :label="true">指定买方</el-radio>
                                <el-radio :label="false">不指定买方</el-radio>
                            </el-radio-group>
                            <el-form-item label="指定买方" prop="Recycler">
...
const handleApply = (valid) => {
    ...
    if (valid) {
        ...
        formData.append("point", ruleForm.id)
        ...
        pointStore.tradeApply(formData)
        .then(() => {
